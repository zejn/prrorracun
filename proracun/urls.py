...
urlpatterns = patterns('',
    ...
    # areachart
    url(r'^p/proracun_area_(?P<po>(:?prihodki|odhodki))_(?P<sifra>\d+).js$', 'proracun.views.areachart_js', name='proracun_areachart_js'),
    url(r'^p/a/(?P<po>(:?prihodki|odhodki))/$', 'proracun.views.areachart', name='proracun_areachart'),
)
